    ...
    <div className="mx-auto max-w-7xl px-5 py-6 lg:px-8">
      <section className="mb-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Search titles and question bodies. Answers appear on thread pages only.
        </p>
      </section>
        ...
        <aside className="space-y-5">
          <SidebarModule title="Filter" bodyClassName="space-y-4">
            <form action="/search" method="get" className="space-y-4">
              ...
              <label className="block">
                <span className="mb-1 block text-xs text-muted-foreground">Sort</span>
                <select
                  name="sort"
              ...
              <label className="block">
                <span className="mb-1 block text-xs text-muted-foreground">Tag</span>
                <select
                  name="tag"
